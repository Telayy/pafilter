...
-->
                ...
                <div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(categories.category_name) FROM products LEFT JOIN categories ON products.product_category = categories.cat_id";
				...
				<div class="list-group">
                    ...
                    $query = "SELECT DISTINCT(fam.family) FROM products LEFT JOIN fam ON products.product_family = fam.fam_id";
                    $statement = $connect->prepare($query);
                    $statement->execute();
                    $result = $statement->fetchAll();
                    foreach($result as $row)
